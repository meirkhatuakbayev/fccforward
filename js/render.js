...
function renderKpis() {
    ...
    const items = [
        {lab: "Лимит по РК",              big: fmtMlrd(t.limit),    unit: "₸",    sub: t.limit.toLocaleString("ru-RU") + " ₸"},
        {lab: "Профинансировано",          big: fmtMlrd(t.fin[2]),   unit: "₸",    sub: finPct.toFixed(1) + "% от лимита", pct: finPct},
