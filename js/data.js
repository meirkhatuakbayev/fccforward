...
function parseSvod(rows) {
    ...
    if (itogo >= 0) {
        const r = rows[itogo];
        const stages = [["Поступило заявок", 3, 4, 5, 6], ["С учётом отказов и уменьшений", 7, 8, 9, 10],
            ["Утверждено Координационным Советом", 11, 12, 13, 14], ["Заключено договоров", 15, 16, 17, 18], ["Профинансировано", 19, 20, 21, 22]];
